...
import { useGridStackRenderContext } from './gridstack.render.context';
...
function parseWeightMetaToComponentData(meta: GridStackWidget): ComponentDataType & { error: unknown } {
  let error = null;
  let name = '';
  let props = {};
  try {
